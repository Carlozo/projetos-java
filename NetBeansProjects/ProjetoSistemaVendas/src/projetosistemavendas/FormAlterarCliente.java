...
public class FormAlterarCliente extends javax.swing.JFrame {
    ClasseCliente clienteAlterar;
    /**
     * Creates new form FormAlterarCliente
     */
    public FormAlterarCliente(ClasseCliente cliente) {
        initComponents();
        this.centralizeFrame();
        this.clienteAlterar = cliente;
        jTextField1.setText(this.clienteAlterar.getCpf());
        jTextField2.setText(this.clienteAlterar.getNome());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            clienteAlterar.setCpf(jTextField1.getText());
            clienteAlterar.setNome(jTextField2.getText());
